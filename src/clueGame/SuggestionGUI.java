...
public class SuggestionGUI extends JFrame{
	...
	public SuggestionGUI(String titleString) {	
	...
	private class ComboListener implements ActionListener {
		  public void actionPerformed(ActionEvent e)
		  {
		    if (e.getSource() == personComboBox)
		      personComboBox.getSelectedItem().toString();
		    else
		      weaponComboBox.getSelectedItem().toString();
		  }
		}
	...
	public static void main(String[] args) {
		...
		SuggestionGUI gui = new SuggestionGUI("Suggestion");
		gui.setVisible(true);
	}
}
